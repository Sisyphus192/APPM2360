...
% This file calculates and plots the nullclines and a sample solutions for
% the system of DEs for problem 3.2.2 in project 3
...
lgd = legend([p(1:5)],...
             ...
             'Sample solution @$(v_0,h_0) = (0+\beta,0), \beta=0.25$');
lgd.Box = 'on';
